...
namespace Application.CQS.User.Commands.Roles.AssignRole
{
    ...
    /// <param name="RoleIds">The role that will be assign from assigner to user</param>
    public record AssignRoleCommand(Guid AssignerId,Guid UserId,List<Guid> RoleIds) : ICommand<List<Guid>>;
}
