...
{
    public class ApiResponseModelBinder : IModelBinder
    {
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            using (var reader = new StreamReader(bindingContext.HttpContext.Request.Body))
            {
                try
                {
                    ...
                    var data = JsonSerializer.Deserialize<ApiResponse<object>>(body, jsonOpt);
                    ...
                    Type returnType = typeof(ApiResponse<>).MakeGenericType(targetModel);
                    ...
                    var dataProp = finalData.GetType().GetProperty(nameof(ApiResponse<object>.Data));
