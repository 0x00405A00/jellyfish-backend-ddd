...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Chat>(entity =>
        {
            ...
            entity.Property(e => e.Uuid)
                .HasMaxLength(36)
                .HasColumnName("uuid").ValueGeneratedNever();
        ...
        modelBuilder.Entity<ChatRelationToUser>(entity =>
        {
            ...
            entity.Property(e => e.DeletedTime)
                .HasColumnType("datetime")
                .HasColumnName("deleted_time");
            entity.Property(e => e.IsChatAdmin).HasColumnName("is_chat_admin");
            entity.Property(e => e.LastModifiedTime)
                .HasColumnType("datetime")
                .HasColumnName("last_modified_time");
            entity.Property(e => e.UserUuid)
        ...
        {
            entity.HasKey(e => new { e.MessageUuid, e.UserUuid }).HasName("PRIMARY");
            ...
            entity.HasOne(d => d.MessageUu).WithMany(p => p.MessageAcknowledges)
        ...
        {
            entity.HasKey(e => new { e.ChatUuid, e.TargetUserUuid, e.Uuid }).HasName("PRIMARY");
        ...
        {
            entity.HasKey(e => new { e.UserUuid, e.FriendUserUuid, e.Uuid }).HasName("PRIMARY");
        ...
        {
            entity.HasKey(e => new { e.UserUuid, e.TargetUserUuid, e.Uuid }).HasName("PRIMARY");
        ...
        {
            entity.HasKey(e => new { e.UserUuid, e.RoleUuid, e.Uuid }).HasName("PRIMARY");
